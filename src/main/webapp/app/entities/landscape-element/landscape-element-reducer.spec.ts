...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './landscape-element.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANDSCAPEELEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_LANDSCAPEELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LANDSCAPEELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LANDSCAPEELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LANDSCAPEELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LANDSCAPEELEMENT actions', async () => {
      const expectedActions = [
        {
