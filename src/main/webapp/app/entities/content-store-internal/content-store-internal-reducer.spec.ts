...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './content-store-internal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTSTOREINTERNAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENTSTOREINTERNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTSTOREINTERNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTSTOREINTERNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTSTOREINTERNAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTSTOREINTERNAL actions', async () => {
      const expectedActions = [
        {
