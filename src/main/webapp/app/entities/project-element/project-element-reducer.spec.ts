...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTELEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTELEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTELEMENT actions', async () => {
      const expectedActions = [
        {
