...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './text-file-content.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEXTFILECONTENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEXTFILECONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEXTFILECONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEXTFILECONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEXTFILECONTENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEXTFILECONTENT actions', async () => {
      const expectedActions = [
        {
