    ...
    <Row>
      <Col md="8">
        <h2 data-cy="teamDetailsHeading">
          <Translate contentKey="archiscapeCoreApp.team.detail.title">Team</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="archiscapeCoreApp.team.id">Id</Translate>
            </span>
          </dt>
          <dd>{teamEntity.id}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="archiscapeCoreApp.team.description">Description</Translate>
            </span>
          </dt>
          <dd>{teamEntity.description}</dd>
          <dt>
            <Translate contentKey="archiscapeCoreApp.team.user">User</Translate>
          </dt>
          <dd>
            {teamEntity.users
