  ...
  return (
    <div>
      <h2 id="team-heading" data-cy="TeamHeading">
        <Translate contentKey="archiscapeCoreApp.team.home.title">Teams</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="archiscapeCoreApp.team.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/team/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="archiscapeCoreApp.team.home.createLabel">Create new Team</Translate>
          </Link>
        </div>
      </h2>
        ...
        {teamList && teamList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="archiscapeCoreApp.team.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="archiscapeCoreApp.team.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/team/${team.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="archiscapeCoreApp.team.home.notFound">No Teams found</Translate>
            </div>
          )
        )}
      </div>
