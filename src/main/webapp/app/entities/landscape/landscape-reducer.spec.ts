...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './landscape.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANDSCAPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LANDSCAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LANDSCAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LANDSCAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LANDSCAPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LANDSCAPE actions', async () => {
      const expectedActions = [
        {
