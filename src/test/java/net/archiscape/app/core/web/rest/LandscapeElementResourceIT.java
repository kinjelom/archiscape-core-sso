...
class LandscapeElementResourceIT {
    ...
    void createLandscapeElement() throws Exception {
        ...
        LandscapeElementDTO landscapeElementDTO = landscapeElementMapper.toDto(landscapeElement);
        restLandscapeElementMockMvc
            .perform(
                post(ENTITY_API_URL)
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(landscapeElementDTO))
            )
    ...
    void putNewLandscapeElement() throws Exception {
        ...
        LandscapeElementDTO landscapeElementDTO = landscapeElementMapper.toDto(updatedLandscapeElement);

        restLandscapeElementMockMvc
            .perform(
                put(ENTITY_API_URL_ID, landscapeElementDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(landscapeElementDTO))
            )
    ...
    void patchNonExistingLandscapeElement() throws Exception {
        ...
        restLandscapeElementMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, landscapeElementDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(landscapeElementDTO))
            )
